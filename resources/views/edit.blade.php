...
@section('konten')
    ...
    <form action="/mahasiswa/update" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" required="required" name="nimmhs" value="{{ $mhs->nim }}"> <br>
        </div>
        <div class="form-group">
            <label for="emailmhs">E-mail</label>
            <input type="text" class="form-control" required="required" name="emailmhs" value="{{ $mhs->email }}"> <br>
        </div>
        <div class="form-group">
